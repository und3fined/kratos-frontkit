...
<div class="signin-container" class:dark={isDark}>
...
<style lang="postcss">
	.signin-container {
		@apply w-full sm:w-96 px-6 space-y-4 mb-8;
	}

    .signin-card {
        @apply rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-500 border-opacity-10 p-6;
    }
